# В НАСТОЯЩИЙ МОМЕНТ СНОВА ПРИШЛОСЬ ВЕРНУТЬСЯ К SELENIUM И FIREFOX. НАМУДРИЛИ С ЗАЩИТОЙ. ТРЕБУЕТСЯ ВРЕМЯ ДЛЯ ОБХОДА.

Для работы должен быть установлен браузер firefox.
